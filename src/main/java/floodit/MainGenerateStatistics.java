...
public class MainGenerateStatistics {
	...
	public static void main(String[] args) {
		...
		// FSolution interactiveSolution = new InteractiveMethod(board,
		// numColors).getBestSolution();
...
//		System.out.println(bfSolution);
	...
	private static FSolution best(List<FSolution> sols) {
		return sols.stream().sorted(Comparator.comparing(FSolution::size).reversed()).findFirst().orElse(null);
	}
}
